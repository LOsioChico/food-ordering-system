...
import { OrderItem as OrderItemEntity } from 'apps/order-service/order-domain/order-domain-core/domain/entity/OrderItem';
import { StreetAddress } from 'apps/order-service/order-domain/order-domain-core/domain/value-object/StreetAddress';
import { Product } from 'apps/order-service/order-domain/order-domain-core/domain/entity/Product';
import { OrderItemId } from 'apps/order-service/order-domain/order-domain-core/domain/value-object/OrderItemId';
